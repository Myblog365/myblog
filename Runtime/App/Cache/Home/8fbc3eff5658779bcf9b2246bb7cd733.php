...
<!--<link href="/thinkblog/Public/static/css/bootstrap-theme.css" rel="stylesheet">-->
<!--external css-->
<link href="/thinkblog/Public/static/css/font-awesome/css/font-awesome.min.css" rel="stylesheet" />
<link href="/thinkblog/Public/home/css/style.css" rel="stylesheet">
  ...
  <body class="body-404">
    ...
    <div class="container">
      ...
      <section class="error-wrapper">
          <i class="icon-4042"></i>
          <h1 class="errorcolor">Error!</h1>
          <h2><i class="icon-remove-sign"></i>  <?php echo ($error); ?></h2>
