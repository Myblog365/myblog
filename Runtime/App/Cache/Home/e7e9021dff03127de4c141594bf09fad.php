...
<div class="row">
            ...
            <div class="col-xs-12 col-md-9 main">
                ...
                <section class="tag-info mt30">
                                       <?php if(!empty($cateinfo['img'])): ?><img class="pull-left avatar-32 mr10" src="<?php echo ($cateinfo["path"]); ?>"><?php endif; ?>
...
<?php $map=array($cid,'true','0','1','id desc','','5','','','','','',);$data = callApi("Art/getArt",$map);$__LIST__ = $data['data']; if(is_array($__LIST__)): $i = 0; $__LIST__ = $__LIST__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><section class="stream-list__item">
    <div class="blog-rank">
