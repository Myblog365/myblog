...
<div id="comment-body">
		<div class="row">
            <div class="col-md-1">
                <?php if(($comment["uid"]) == "0"): ?><img src="<?php echo getRootUrl();?>Addons/Avatar/default_64_64.jpg" class="avatar" width="52" height="52" style="display: block;">
                    <?php else: ?>
                    <img src="<?php echo ($comment["user"]["avatar64"]); ?>" class="avatar" width="52" height="52" style="display: block;"><?php endif; ?>
