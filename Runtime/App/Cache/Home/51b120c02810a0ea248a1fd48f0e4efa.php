...
<?php $map=array('0','true','0','1','tj desc,view desc,id desc','','10','','','','','',);$data = callApi("Art/getArt",$map);$__LIST__ = $data['data']; if(is_array($__LIST__)): $i = 0; $__LIST__ = $__LIST__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><section class="stream-list__item">
    <div class="blog-rank">
...
<?php echo ($catehtml); ?>
                                ...
                                <div class="widget-box clearfix">
                    <h2 class="h4 widget-box__title">最近登录</h2>
