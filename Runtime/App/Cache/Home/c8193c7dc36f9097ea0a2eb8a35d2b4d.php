...
<?php $map=array('0','true','0','1','id desc','','5','','','','','',);$data = callApi("Art/getArt",$map);$__LIST__ = $data['data']; if(is_array($__LIST__)): $i = 0; $__LIST__ = $__LIST__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><section class="stream-list__item">
    <div class="blog-rank">
                ...
                <?php echo (friendlyDate($vo["create_time"])); ?>
                 ...
                 <code class="cat_type"><a href="<?php echo ZSU('/artlist/'.$vo['cid'],'Index/artlist',array('cid'=>$vo['cid']));?>"><?php echo (get_cate_nameByid($vo["cid"])); ?></a></code>
                   ...
                   <!--   <?php if($vo['img'] != ''): ?><div class="entry-thumbnail">
                        ...
                        <img src="<?php echo ($vo["img"]); ?>" alt="<?php echo ($vo["title"]); ?>" >
                        </a>
                        </div><?php endif; ?>-->
...
<?php $map=array('0','true','0','1','','','','',);$data = callApi("Art/getArtCount",$map);$count = $data['data'];$__PAGE__ = new \Think\Page($count, 5);echo $__PAGE__->show(); ?>
