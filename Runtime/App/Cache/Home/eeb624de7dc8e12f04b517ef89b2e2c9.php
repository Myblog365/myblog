...
<div id="main" class="settings col-md-8 form-horizontal">
            ...
            <!-- Nav tabs -->
                ...
                <div class="row mt30">
                    ...
                    <div class="col-md-8">
                        <form id="setting" action="<?php echo U('User/changeinfo');?>" target=formAjax method="post">
                       <input type="hidden" name="uid" value="<?php echo ($cxuser["uid"]); ?>" />
                        <div class="form-group">
                            <label for="setting-name" class="required control-label col-sm-3">昵称</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="nickname" name="nickname" value="<?php echo ($cxuser["nickname"]); ?>">
                                <small>昵称是你的个性</small>
                            </div>
                        </div>
                         <div class="form-group">
                            <label for="setting-zone" class="control-label col-sm-3"></label>
                            <div class="col-sm-9">
                              <?php echo hook('J_China_City',array('province'=>$cxuser['pos_province'],'city'=>$cxuser['pos_city'],'district'=>$cxuser['pos_district'],'community'=>$cxuser['pos_community']));?>
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="setting-description" class="control-label col-sm-3">个性签名</label>
                            <div class="col-sm-9">
                               <textarea class="form-control autosize" rows="6" name="signature" id="signature"><?php echo ($cxuser["signature"]); ?></textarea>
                            </div>
                        </div>
