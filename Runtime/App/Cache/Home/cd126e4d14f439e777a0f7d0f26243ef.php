...
<div class="row">
            ...
            <div class="col-xs-12 col-md-9 main">
                ...
                <section class="tag-info mt30">
                                      <h1 class="h3">搜索关键词:“<span style="color:red;"><?php echo ($keyword); ?></span>”得到：</h1>
...
<?php $map=array('0','true','0','1','tj desc,id desc','','10','',$keyword,'','','',);$data = callApi("Art/getArt",$map);$__LIST__ = $data['data']; if(is_array($__LIST__)): $i = 0; $__LIST__ = $__LIST__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><section class="stream-list__item">
    <div class="blog-rank">
...
<?php $map=array('0','true','0','1','',$keyword,'','',);$data = callApi("Art/getArtCount",$map);$count = $data['data'];$__PAGE__ = new \Think\Page($count, 10);echo $__PAGE__->show(); ?>
                ...
                <div class="art_left_list ">
                 ...
                 <div class="widget-box clearfix">
                    <div class="art_title">最近评论</div>
                     <div class="user_list">
                         <img border="0" alt="" src="/thinkblog/Addons/Avatar/default_32_32.jpg">：<a id="link" href="cont.php?id=4">很不错的文章，，我12</a>
                     </div>
                     <div class="user_list">
                         <img border="0" alt="" src="/thinkblog/Addons/Avatar/default_32_32.jpg">：<a id="link" href="cont.php?id=4">很不错的文章，，我123</a>
                     </div>
                     <div class="user_list">
                         <img border="0" alt="" src="/thinkblog/Addons/Avatar/default_32_32.jpg">：<a id="link" href="cont.php?id=4">很不错的文章，，我324</a>
                     </div>
                     <div class="user_list">
                         <img border="0" alt="" src="/thinkblog/Addons/Avatar/default_32_32.jpg">：<a id="link" href="cont.php?id=4">很不错的文章，，我234</a>
                     </div>
                </div>
                                                <div class="widget-box clearfix">
