...
<div id="main" class="settings col-md-8 form-horizontal">
            ...
            <!-- Nav tabs -->
                    ...
                    <div class="form-group mt30">
                        <label for="setting-mail" class="required control-label col-sm-2">Email 地址</label>
                        <div class="col-sm-8">
                          
			
			<div class="input-group">
				<input type="text" <?php if($expinfo['email'] != ''): ?>disabled<?php endif; ?> class="form-control" id="email" name="email" value="<?php echo ($expinfo["email"]); ?>">
				<span class="input-group-btn">
				<button class="btn btn-default" type="button" id="get_verify_email">
				<?php if($expinfo['email'] != ''): ?><span class="changemail" onclick="changemail(this)" >修改邮箱</span><?php endif; ?>
				 
				 
			    <span <?php if($expinfo['email'] != ''): ?>style="display:none"<?php endif; ?> class="get" href="<?php echo U('Home/Home/send_mail');?>" >获取验证邮件</span>
			   
				
				
				<span class="wait" style="display:none">获取中请稍候</span></button></span>
			</div>
			<p class="help-block small"><span style="color:#d44950;">
			<?php if($expinfo['email'] != ''): ?>该邮箱已经验证通过！
			<?php else: ?>
			请验证一个邮箱地址，否则你将无法接收邮件通知和密码找回！<?php endif; ?>
			</span></p>
