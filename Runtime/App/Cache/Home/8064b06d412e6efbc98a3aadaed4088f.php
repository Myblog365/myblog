...
<div class="row">
            ...
            <div class="col-xs-12 col-md-9 main">
                ...
                <section class="tag-info mt30">
                                        <?php if(!empty($taginfo['img'])): ?><img class="pull-left avatar-32 mr10" src="<?php echo ($taginfo["path"]); ?>"><?php endif; ?>
                                        <h1 class="h3"><?php echo ($taginfo["title"]); ?>
                                      <?php if($hasgz): ?><a callback="focusnum" id="focusnum<?php echo ($taginfo['id']); ?>" href="<?php echo U('Index/focusnum',array('id'=>$taginfo['id'],'mark'=>'sideTagmarked','type'=>2));?>" target=AjaxTodo class="btn btn-default btn-sm" alt="关注">取消关注</a>
                                                                                                <?php else: ?>
                                                                                                <a callback="focusnum" id="focusnum<?php echo ($taginfo['id']); ?>"  href="<?php echo U('Index/focusnum',array('id'=>$taginfo['id'],'mark'=>'sideTagmarked','type'=>2));?>" target=AjaxTodo class="btn btn-success btn-sm" alt="取消关注">关注</a><?php endif; ?>
                              
                        <small><strong id="sideTagmarked" class="follows"><?php echo ($focusnum); ?></strong> 人关注</small></h1>
                    <ul class="list-inline">
                                            </ul>

                                        <div class="mb20">
                        <p><?php echo ($taginfo["des"]); ?></p>
                                            </div>
...
<?php $map=array('0','true','0','1','id desc','','10',$tag,'','','','',);$data = callApi("Art/getArt",$map);$__LIST__ = $data['data']; if(is_array($__LIST__)): $i = 0; $__LIST__ = $__LIST__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><section class="stream-list__item">
        <div class="blog-rank">
                    ...
                    <div class="l_con">
                        <a href="<?php echo ZSU('/artc/'.$vo['id'],'Index/artc',array('id'=>$vo['id']));?>">
                            <?php if($vo['thumb'] != ''): ?><img border="0" alt="<?php echo ($vo["title"]); ?>" src="<?php echo getPicUrl($vo['thumb']);?>">
                                <?php else: ?>
                                <img border="0" alt="<?php echo ($vo["title"]); ?>" src="/Public/home/images/art_default.jpg"><?php endif; ?>
                        </a>
                    </div>
                    <div class="r_con">
    ...
    <div class="bottom_line"></div><?php endforeach; endif; else: echo "" ;endif; ?>
            ...
            <?php $map=array('0','true','0','1',$tag,'','','',);$data = callApi("Art/getArtCount",$map);$count = $data['data'];$__PAGE__ = new \Think\Page($count, 10);echo $__PAGE__->show(); ?>
