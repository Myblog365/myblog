...
<a href="<?php echo U('add');?>" rel="hookadd"  title="新增钩子"  class="btn medium bg-green"><span class="button-content">
    ...
    <table class="table text-left"  id="zstable" >
        ...
        <tbody>
           <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td>
                    <a href="<?php echo U('edit',array('id'=>$vo['id']));?>" rel="hookedit<?php echo ($vo['id']); ?>"  class="btn small bg-blue" title="编辑<?php echo ($vo["name"]); ?>钩子" ><span class="button-content"><i class="glyph-icon icon-edit"></i> 编辑</span></a>
