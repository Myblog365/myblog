...
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr><td></td>
                        ...
                        <td class="action  text-center">
                            <a href="javascript:void(0);" onclick="importdata(this);"  class="btn medium bg-green" url="<?php echo U('Dataimport/import',array('time'=>$data['time']));?>"><span class="button-content">还原</span></a>&nbsp;
                            <a target="ajaxTodo" class="btn medium bg-red" href="<?php echo U('del',array('time'=>$data['time']));?>"  title="确定要删除该备份吗？"><span class="button-content"><i class="glyph-icon icon-trash-o"></i> 删除</span></a>
                        </td>
