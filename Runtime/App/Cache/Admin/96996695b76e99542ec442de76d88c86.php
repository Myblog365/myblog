...
<div id="page-content">
       ...
       <div class="example-code">
        <a href="<?php echo U('add');?>" target="dialog"  width="430px" height="440px" class="btn medium bg-orange"><span class="button-content"><i class="glyph-icon icon-pencil-square-o"></i>发消息</span></a>
    ...
    <div class="dropdown float-right mrg15R">
                                ...
                                <ul class="dropdown-menu float-right">
                                     ...
                                     <li class="hidden">
                                        <a href="/thinkblog/index.php/Admin/Message/outxls/ids/all" target="dwzExport">
                                            <i class="glyph-icon icon-sign-out font-size-13 mrg5R"></i>
                                            <span class="font-bold">导出全部</span>
                                        </a>
                                    </li>
                                     <li class="hidden">
                                        <a href="/thinkblog/index.php/Admin/Message/outxls" target="checkedExport" idname="ids">
                                            <i class="glyph-icon icon-sign-out font-size-13 mrg5R"></i>
   ...
   <table class="table text-left"  id="zstable">
        <thead>
            <tr>
                ...
                <th class="text-center nosort" width="28"><input type="checkbox" class="checkboxCtrl j-icheck" group="ids"></th>
                <th class="text-center nosort" width="40">操作</th>
            </tr>
        </thead>
        <tbody>
           ...
           <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            <td></td>
                <td><?php echo (get_username($vo['from_uid'])); ?></td>
                <td><?php echo (get_username($vo['to_uid'])); ?></td>
                <td><?php echo ($vo['title']); ?></td>
                 <td><?php echo ($vo['content']); ?></td>
                  <td><?php echo (toDate($vo['create_time'])); ?></td>
                   <td><?php echo ($vo['typetext']); ?></td>
