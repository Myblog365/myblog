  ...
  <table class="table text-left"  id="zstable">
        ...
        <tbody>
           <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				...
				<td>
                    <a href="<?php echo U('Home/Index/artc',array('id'=>$vo['id']));?>" target="_blank"><?php echo (str_cut($vo["title"],0,28,'utf-8',false)); ?></a>
                    <?php if($vo["thumb"] != ''): ?><img src="/Public/admin/images/img.gif" border="0" title="有缩略图" style="cursor : pointer;width:16px;height:15px;" /><?php endif; ?>
                </td>
