...
<div id="page-content">
    ...
    <div class="form-row">
        ...
        <div class="form-input col-md-5">
            <input type="text"  name="tag" id="tag" value="<?php echo ($info["tag"]); ?>">
      ...
      <div class="form-row">
         ...
         <div class="form-input col-md-7">
             ...
             <textarea name="description"  id="j_description" class='keditor required' style="width:600px;min-height:400px;visibility:hidden;"><?php echo ($info["description"]); ?></textarea>
