...
<div id="page-content">
  ...
  <form  class="row" action="<?php echo U('index');?>" method="post" id="formsearch">
...
<div class="example-code">
  ...
  <button type="submit" class="btn medium bg-orange"> <span class="button-content">
               ...
               查询
                ...
                <a href="<?php echo U('add');?>" target="dialog"  width="460px" height="420px"  title="新增菜单" class="btn medium bg-green">
                ...
                <i class="glyph-icon icon-plus"></i> 新增
                            ...
                            <div class="dropdown float-right mrg15R">
                                ...
                                <ul class="dropdown-menu float-right">
                                     ...
                                     <li class="hidden">
                                        <a href="/thinkblog/index.php/Admin/Nav/outxls/ids/all" target="dwzExport">
                                            <i class="glyph-icon icon-sign-out font-size-13 mrg5R"></i>
                                            <span class="font-bold">导出全部</span>
                                        </a>
                                    </li>
                                     <li class="hidden">
                                        <a href="/thinkblog/index.php/Admin/Nav/outxls" target="checkedExport" idname="ids">
                                            <i class="glyph-icon icon-sign-out font-size-13 mrg5R"></i>
        ...
        <tbody>
           ...
           <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            <td></td>
                ...
                <td class="text-center"><?php echo ($vo['sort']); ?></td>
                <td class="text-center"><?php echo (getStatus($vo['status'])); ?></td>
               <td class="text-center"><?php echo (getenablename($vo['win'])); ?></td>
               
                <td><input type="checkbox" name="ids" class="j-icheck" value="<?php echo ($vo['id']); ?>"></td>
                <td>
                    <a href="<?php echo U('edit',array('id'=>$vo['id']));?>"  class="btn small bg-blue" target="dialog"   width="460px" height="420px" ><span class="button-content"><i class="glyph-icon icon-edit"></i> 编辑</span></a>
