...
<div id="page-content">
    ...
    <form action="<?php echo U('Cate/insert');?>" id="j_custom_form" class="col-md-12 form-label-right form-validate" method="post" url="<?php echo U('Cate/index');?>" callback="TabAjaxDone" noEnter>
...
<div class="col-md-7">
					...
					<div class="upload-img-box">
						...
						<img src="/thinkblog<?php echo ($info["path"]); ?>"/></div><?php endif; ?>
					</div>
