<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html>
    ...
    <head>
        ...
        <meta name="description" content="kevin-Myblog365博客交流">
...
<div id="page-content">
    ...
    <form action="<?php echo U('Article/insert');?>"  id="j_custom_form" class="form-validate col-md-12" method="post" url="<?php echo U('Article/index');?>" callback="TabAjaxDone" noEnter>
    
     <div class="form-row">
	     <div class="form-label col-md-2 text-right"> <label>文章标题：</label> </div>
      ...
      <div class="form-row">
         ...
         <div class="form-input col-md-9">
             <div style="float:left;width:390px;">
                <input type="text" class=" " name="thumb" id="thumb" value="" size="50"/>  &nbsp;
             </div>
        ...
        <div class="form-row">
            <div class="form-label col-md-2 text-right"> <label>文章标签：</label> </div>

            <div class="form-input col-md-5">
                <input type="text"  name="tag" id="tag" value=""  >
                <div class="font-yellow mrg10T">多个标签请用，半角逗号连接</div>
            </div>
        </div>
         ...
         <div class="form-row">
	        <div class="form-label col-md-2 text-right"><label>内容：</label> </div>
             ...
             <!--<textarea name="description"  class="j-content validate[required] required""   minheight="400"></textarea>-->

                 <textarea name="description" id="j_description"  class='keditor required' style="width:600px;min-height:400px;visibility:hidden;"></textarea>
	 ...
	 <div class="form-input col-md-5">
         <select name="cid"  data-container="body"  id="j_cid" class="selectpicker show-tick validate[required]" data-style="btn medium bg-green" data-width="auto">
               <?php if(is_array($clist)): $i = 0; $__LIST__ = $clist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?><option value="<?php echo ($cate["id"]); ?>"><?php echo ($cate["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
         </select>
...
var token1 = '';
var token2 = '';
var tourl = _STATIC_ + "/kindeditor/getToken.php?type=3";
$(document).ready(function(){

    $.ajax({url: tourl, async: false, success: function(data){
