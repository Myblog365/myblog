      ...
      <div class="form-row">
         ...
         <div class="form-row">
	        <div class="form-label col-md-2 text-right"><label>内容：</label> </div>
             ...
             <textarea name="description" id="j_description"  class="j-content validate[required] required"" uploadJson="<?php echo U('File/ke_upimg');?>" fileManagerJson="<?php echo U('File/editorfilemanager');?>"  minheight="400"></textarea>
