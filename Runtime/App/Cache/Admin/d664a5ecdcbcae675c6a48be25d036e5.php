...
<div id="page-content">
    ...
    <form  action="<?php echo U('index');?>" method="post" id="formsearch">
       ...
       <input type="text" value="<?php echo ($_REQUEST["content"]); ?>" name="content" size="13" />
       </div>
    <button type="submit" class="btn medium bg-orange"> <span class="button-content">
         ...
         <div class="dropdown float-right mrg15R">
                                ...
                                <ul class="dropdown-menu float-right">
                                     ...
                                     <li class="hidden">
                                        <a href="/thinkblog/index.php/Admin/Comments/outxls/ids/all" target="dwzExport">
                                            <i class="glyph-icon icon-sign-out font-size-13 mrg5R"></i>
                                            <span class="font-bold">导出全部</span>
                                        </a>
                                    </li>
                                     <li class="hidden">
                                        <a href="/thinkblog/index.php/Admin/Comments/outxls" target="checkedExport" idname="ids">
                                            <i class="glyph-icon icon-sign-out font-size-13 mrg5R"></i>
 ...
 <th>状态</th>
                ...
                <th class="nosort text-center" width="28"><input type="checkbox" class="checkboxCtrl j-icheck" group="ids"></th>
                <th class="nosort text-center" width="50">操作</th>
            </tr>
        </thead>
        <tbody>
           ...
           <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            <td></td>
                <td><?php echo (op_t($vo['content'])); ?></td>
                 <td><a href="<?php echo ($vo['rowurl']); ?>" target="_blank"><?php echo (msubstr($vo['rowtitle'],0,6)); ?></a></td>
                <td><?php echo (get_username($vo['uid'])); ?></td>
                <td><?php echo ($vo['mod']); ?></td>
                <td><?php echo (toDate($vo['create_time'],'Y-m-d H:i')); ?></td>
                <td><?php echo ($vo['ding']); ?></td>
                <td><?php echo ($vo['cai']); ?></td>
