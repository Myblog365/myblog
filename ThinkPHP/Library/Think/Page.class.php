...
class Page{
    ...
    private $config  = array(
        ...
        'first'  => '首页',
        'last'   => '末页',
        'theme'  => '%FIRST% %UP_PAGE% %PRESPAN% %LINK_PAGE% %NEXTSPAN% %DOWN_PAGE% %END%',
    );
    ...
    public function show() {
        ...
        $page_str = str_replace(
            array('%HEADER%', '%NOW_PAGE%', '%PRESPAN%', '%NEXTSPAN%', '%UP_PAGE%', '%DOWN_PAGE%', '%FIRST%', '%LINK_PAGE%', '%END%', '%TOTAL_ROW%', '%TOTAL_PAGE%'),
            array($this->config['header'], $this->nowPage, $prespan, $nextspan, $up_page, $down_page, $the_first, $link_page, $the_end, $this->totalRows, $this->totalPages),
            $this->config['theme']);
